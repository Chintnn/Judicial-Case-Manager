...
public class HearingPanel extends JPanel {
    ...
    private void loadHearingData() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Failed to load hearings: " + e.getMessage());
        }
    }
    ...
    private void addHearing() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error adding hearing: " + e.getMessage());
        }
    }
    ...
    private void updateHearing() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error updating hearing: " + e.getMessage());
        }
    }
