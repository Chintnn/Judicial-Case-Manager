    ...
    <div class="container mt-5">
        ...
        <form action="persons" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="personId" name="personId" value="<%= person.getPersonId() %>" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" value="<%= person.getDateOfBirth() %>" required>
            </div>
            <div class="mb-3">
                <label for="contact" class="form-label">Contact</label>
                <input type="text" class="form-control" id="contact" name="contact" value="<%= person.getContact() %>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nationalId" name="nationalId" value="<%= person.getNationalId() %>" required>
            </div>
